...
class PaymentDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    id: Field::Number,
    collection_id: Field::Number,
    collection_status: Field::String,
    external_reference: Field::String,
    merchant_account_id: Field::String,
    merchant_order_id: Field::String,
    payable: Field::Polymorphic,
    payment_id: Field::Number,
    payment_type: Field::String,
    preference_id: Field::String,
    processing_mode: Field::String,
